...
import { ledOn, ledOff, sendDataToWS } from "../functions/genericFc";

const LocalDeviceControls = ({ route, navigation }) => {
    ...
    >
      ...
      <TouchableOpacity
        ...
        onPress={async () => {
          ...
          await sendDataToWS(obj, item.ip)
...
export default LocalDeviceControls;
